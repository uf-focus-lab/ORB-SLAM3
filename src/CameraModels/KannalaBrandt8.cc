...
//BOOST_CLASS_EXPORT_GUID(KannalaBrandt8, "KannalaBrandt8")
    ...
    bool KannalaBrandt8::ReconstructWithTwoViews(const vector<cv::KeyPoint>& vKeys1, const vector<cv::KeyPoint>& vKeys2, const vector<int> &vMatches12,
        ...
        vector<cv::KeyPoint> vKeysUn1 = vKeys1, vKeysUn2 = vKeys2;
