...
int main(int argc, char **argv) {
  ...
  auto imu_callback = [&](const rs2::frame &frame) {
    ...
    if (rs2::frameset fs = frame.as<rs2::frameset>()) {
      ...
      if (m_frame.get_profile().stream_name() == "Gyro") {
        ...
        // cout << "Gyro:" << gyro_sample.x << ", " << gyro_sample.y << ", " <<
        // gyro_sample.z << endl;
        ...
        // cout << "Accel:" << current_accel_data.x << ", " <<
        // current_accel_data.y << ", " << current_accel_data.z << endl;
      }
    }
  };
  ...
  cout << " Coeff = " << intrinsics_left.coeffs[0] << ", "
  ...
  cout << "Right camera: \n";
  cout << " fx = " << intrinsics_right.fx << endl;
  cout << " fy = " << intrinsics_right.fy << endl;
  cout << " cx = " << intrinsics_right.ppx << endl;
  cout << " cy = " << intrinsics_right.ppy << endl;
  cout << " height = " << intrinsics_right.height << endl;
  cout << " width = " << intrinsics_right.width << endl;
  cout << " Coeff = " << intrinsics_right.coeffs[0] << ", "
       << intrinsics_right.coeffs[1] << ", " << intrinsics_right.coeffs[2]
       << ", " << intrinsics_right.coeffs[3] << ", "
       << intrinsics_right.coeffs[4] << ", " << endl;
  cout << " Model = " << intrinsics_right.model << endl;
