...
public:
  ...
  void PreSave(set<GeometricCamera *> &spCams);
  void
  ...
  set<long unsigned int> msOptKFs;
  set<long unsigned int> msFixedKFs;
...
protected:
  ...
  vector<MapPoint *> mvpBackupMapPoints;
  vector<KeyFrame *> mvpBackupKeyFrames;
