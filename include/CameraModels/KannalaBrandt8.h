...
public:
  ...
  KannalaBrandt8(const vector<float> _vParameters)
  ...
  KannalaBrandt8(const vector<float> _vParameters, const float _precision)
  ...
  bool ReconstructWithTwoViews(const vector<cv::KeyPoint> &vKeys1,
