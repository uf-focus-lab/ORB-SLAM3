...
public:
  ...
  void SetParam(const vector<Eigen::Matrix3d> &_Rcw,
                const vector<Eigen::Vector3d> &_tcw,
                const vector<Eigen::Matrix3d> &_Rbc,
...
public:
  ...
  // For set of cameras
  vector<Eigen::Matrix3d> Rcw;
  vector<Eigen::Vector3d> tcw;
  vector<Eigen::Matrix3d> Rcb, Rbc;
  vector<Eigen::Vector3d> tcb, tbc;
  double bf;
  vector<GeometricCamera *> pCamera;
