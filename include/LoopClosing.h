...
public:
  ...
  typedef map<KeyFrame *, g2o::Sim3, less<KeyFrame *>,
              Eigen::aligned_allocator<pair<KeyFrame *const, g2o::Sim3>>>
      KeyFrameAndPose;
...
protected:
  ...
  bool DetectCommonRegionsFromBoW(vector<KeyFrame *> &vpBowCand,
                                  KeyFrame *&pMatchedKF,
  ...
  vector<MapPoint *> mvpLoopMPs;
  vector<MapPoint *> mvpLoopMatchedMPs;
  ...
  vector<MapPoint *> mvpMergeMPs;
  vector<MapPoint *> mvpMergeMatchedMPs;
  vector<KeyFrame *> mvpMergeConnectedKFs;
