...
public:
  ...
  int operator()(cv::InputArray _image, cv::InputArray _mask,
                 vector<cv::KeyPoint> &_keypoints, cv::OutputArray _descriptors,
  ...
  vector<float> inline GetInverseScaleFactors() { return mvInvScaleFactor; }

  vector<float> inline GetScaleSigmaSquares() { return mvLevelSigma2; }
...
protected:
  ...
  vector<cv::KeyPoint>
  DistributeOctTree(const vector<cv::KeyPoint> &vToDistributeKeys,
