...
bool MapDrawer::ParseViewerParamFile(cv::FileStorage &fSettings) {
  ...
  if (!node.empty()) {
    ...
    cerr << "*Viewer.KeyFrameSize parameter doesn't exist or is not a real "
            "number*"
         << endl;
    b_miss_params = true;
  }
  ...
  if (!node.empty()) {
    ...
    cerr << "*Viewer.KeyFrameLineWidth parameter doesn't exist or is not a "
            "real number*"
         << endl;
    b_miss_params = true;
  }
  ...
  if (!node.empty()) {
    ...
    cerr << "*Viewer.GraphLineWidth parameter doesn't exist or is not a real "
            "number*"
         << endl;
    b_miss_params = true;
  }
  ...
  if (!node.empty()) {
    ...
    cerr << "*Viewer.PointSize parameter doesn't exist or is not a real number*"
         << endl;
    b_miss_params = true;
  }
  ...
  if (!node.empty()) {
    ...
    cerr << "*Viewer.CameraLineWidth parameter doesn't exist or is not a real "
            "number*"
         << endl;
    b_miss_params = true;
  }
  ...
  if (bDrawKF) {
    for (size_t i = 0; i < vpKFs.size(); i++) {
      ...
      if (!pKF->GetParent()) // It is the first KF in the map
      {
        ...
        // cerr << "Child KF: " << vpKFs[i]->mnId << endl;
