...
Frame::Frame(const cv::Mat &imLeft, const cv::Mat &imRight,
  ...
  // ORB extraction
#ifdef REGISTER_TIMES
  chrono::steady_clock::time_point time_StartExtORB =
  ...
  threadRight.join();
#ifdef REGISTER_TIMES
  chrono::steady_clock::time_point time_EndExtORB = chrono::steady_clock::now();

  mTimeORB_Ext = chrono::duration_cast<chrono::duration<double, milli>>(
...
#ifdef REGISTER_TIMES
  chrono::steady_clock::time_point time_StartStereoMatches =
      chrono::steady_clock::now();
#endif
  ComputeStereoMatches();
#ifdef REGISTER_TIMES
  chrono::steady_clock::time_point time_EndStereoMatches =
      chrono::steady_clock::now();

  mTimeStereoMatch = chrono::duration_cast<chrono::duration<double, milli>>(
...
bool Frame::imuIsPreintegrated() {
  unique_lock<mutex> lock(*mpMutexImu);
